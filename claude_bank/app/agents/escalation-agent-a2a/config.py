...
# Agent Settings
ESCALATION_AGENT_NAME = os.getenv("ESCALATION_AGENT_NAME", "EscalationAgent")
ESCALATION_AGENT_VERSION = int(os.getenv("ESCALATION_AGENT_VERSION", "1"))
ESCALATION_AGENT_MODEL_DEPLOYMENT = os.getenv("ESCALATION_AGENT_MODEL_DEPLOYMENT", "gpt-4.1-mini")
